      ...
      `;
        ...
        `,
            ...
            for (const r of statsRows) {
                ...
                if (!campaignAccum.has(cid))
                    campaignAccum.set(cid, { clicks: 0, conversions: 0, revenue: 0, cost: 0 });
            ...
            for (const [cid, campRows] of byCampaign) {
                ...
                const streamEdgesFromCamp = new Map();
